...
app.get('/',async function(req,res){
  try{
    ...
    //   db.query('INSERT INTO jokes (joketext, joketype) VALUES ($1, $2)', [ joke.jokeText, joke.jokeType])
...
app.post('/post',function(req,res){
  ...
  const newPost= {
   ...
   console.log('text and type'+req.body.text+req.body.type);
   jokes.push(newPost)
   try{
    db.query("insert into jokes (joketext, joketype) VALUES ($1, $2)",[req.body.text,req.body.type])
    res.send('sucess')
   }catch(e){
    console.error('errore found'+e.message);
   }
