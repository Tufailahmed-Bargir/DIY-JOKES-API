...
app.get('/jokes/:id',function(req,res){
 ...
 const findedJoke=  jokes.find((joke)=> joke.id ===id)
 console.log(findedJoke);
...
app.get('/filter',function(req,res){
  ...
  // console.log('id is '+id);
 const findedJoke=  jokes.filter((joke)=> joke.jokeType ===type)
 console.log('dats us '+JSON.stringify(findedJoke));
...
app.put('/jokes/:id',function(req,res){
  ...
  const newPost= {
   ...
   console.log('some'+foundjoke);
  //  console.log( jokes[req.params.id]);
   jokes[foundjoke]=newPost;
  //  jokes.push(newPost)
   console.log(newPost);
   res.send(newPost)
 })
...
app.patch('/jokes/:id',function(req,res){
  ...
  //  console.log(jokes.jokeText);
   
  //  console.log(foundjoke);
  //  console.log( jokes[req.params.id]);
  const foundjoked = jokes.findIndex((joke)=> joke.id ===id)
   jokes[foundjoked]=newPost;
  //  jokes.push(newPost)
   console.log(newPost);
   res.send(newPost)
 })
...
app.delete('/all',function(req,res){
  ...
  if(userKey ===masterKey){
    jokes=[]
    res.send('all jokes delete ssuccess')
  }else{
    res.send('you dont have the access to delete all jokes');
  }
